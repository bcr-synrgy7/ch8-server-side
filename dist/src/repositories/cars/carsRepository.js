...
class CarRepository {
    ...
    getCarById(carId) {
        return __awaiter(this, void 0, void 0, function* () {
            return carsModel_1.CarsModel.query().findById(carId);
        });
    }
    createCar(carData) {
        return __awaiter(this, void 0, void 0, function* () {
            return carsModel_1.CarsModel.query().insert(carData);
        });
    }
    updateCar(carId, carData) {
        return __awaiter(this, void 0, void 0, function* () {
            return carsModel_1.CarsModel.query().patchAndFetchById(carId, carData);
        });
    }
    deleteCarById(carId) {
        return __awaiter(this, void 0, void 0, function* () {
