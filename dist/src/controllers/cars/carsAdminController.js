...
const carsAdminServices_1 = __importDefault(require("../../services/cars/carsAdmin/carsAdminServices"));
...
class CarsAdminController {
    ...
    getCarById(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            carsAdminServices_1.default.getCarById(res, carId);
        });
    }
    createCar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
...
exports.default = new CarsAdminController();
